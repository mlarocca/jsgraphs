import DisjointSet from '../../src/disjointset/disjointset.mjs';
import DisjointSetLists from '../../src/disjointset/variants/disjointset_lists.mjs';
import DisjointSetTrees from '../../src/disjointset/variants/disjointset_trees.mjs';
